...
void VRManager::RegisterCVars()
{
	...
	console->Register("vr_button_long_press_time", &vr_button_long_press_time, 0.25f, VF_DUMPTODISK, "How long you need to hold a button down to register as a long press");
